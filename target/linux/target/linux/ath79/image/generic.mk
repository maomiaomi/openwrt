...
define Device/holl_vpod-m1
  $(Device/tplink-16mlzma)
  SOC := ar9331
  DEVICE_VENDOR := HOLL
  DEVICE_MODEL := VPOD-M1
  DEVICE_PACKAGES := kmod-usb-chipidea2
  TPLINK_HWID := 0x07030101
endef
TARGET_DEVICES += holl_vpod-m1

define Device/holl_vpod-m1-8m
  $(Device/tplink-8mlzma)
  SOC := ar9331
  DEVICE_VENDOR := HOLL
  DEVICE_MODEL := VPOD-M1-8M
  DEVICE_PACKAGES := kmod-usb-chipidea2
  TPLINK_HWID := 0x07030101
endef
TARGET_DEVICES += holl_vpod-m1-8m
